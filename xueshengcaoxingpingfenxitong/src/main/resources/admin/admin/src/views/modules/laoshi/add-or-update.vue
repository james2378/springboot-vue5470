               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="老师唯一编号" prop="laoshiUuidNumber">
                       <el-input v-model="ruleForm.laoshiUuidNumber"
                                 placeholder="老师唯一编号" clearable  :readonly="ro.laoshiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="家庭住址" prop="laoshiAddress">
                       <el-input v-model="ruleForm.laoshiAddress"
                                 placeholder="家庭住址" clearable  :readonly="ro.laoshiAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   laoshiUuidNumber: [
                              { required: true, message: '老师唯一编号不能为空', trigger: 'blur' },
                          ],
                   laoshiName: [
