    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='xuesheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="学生唯一编号" prop="xueshengUuidNumber">
                        <el-input v-model="xueshengForm.xueshengUuidNumber"
                                  placeholder="学生唯一编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="学生唯一编号" prop="xueshengUuidNumber">
                            <el-input v-model="ruleForm.xueshengUuidNumber"
                                      placeholder="学生唯一编号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='xuesheng' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='xuesheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="家庭住址" prop="xueshengAddress">
                        <el-input v-model="xueshengForm.xueshengAddress"
                                  placeholder="家庭住址" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="家庭住址" prop="xueshengAddress">
                ...
                <el-col :span="12"  v-if="sessionTable !='laoshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="老师唯一编号" prop="laoshiUuidNumber">
                        <el-input v-model="laoshiForm.laoshiUuidNumber"
                                  placeholder="老师唯一编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="老师唯一编号" prop="laoshiUuidNumber">
                            <el-input v-model="ruleForm.laoshiUuidNumber"
                                      placeholder="老师唯一编号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='laoshi' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='laoshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="家庭住址" prop="laoshiAddress">
                        <el-input v-model="laoshiForm.laoshiAddress"
                                  placeholder="家庭住址" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="家庭住址" prop="laoshiAddress">
                            <el-input v-model="ruleForm.laoshiAddress"
                                      placeholder="家庭住址" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="学年" prop="xuenianTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.xuenianTime"
                                type="year"
                                placeholder="学年"
                                :disabled="ro.xuenianTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xuenianTime" label="学年" prop="xuenianTime">
                            <span v-html="ruleForm.xuenianTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="学期" prop="pingfenTypes">
                        <el-select v-model="ruleForm.pingfenTypes" :disabled="ro.pingfenTypes" placeholder="请选择学期">
                            <el-option
                                v-for="(item,index) in pingfenTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="学期" prop="pingfenValue">
                        <el-input v-model="ruleForm.pingfenValue"
                            placeholder="学期" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学业成绩(60%)" prop="xueyeFenshu">
                       <el-input v-model="ruleForm.xueyeFenshu"
                                 placeholder="学业成绩(60%)" clearable  :readonly="ro.xueyeFenshu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="学业成绩(60%)" prop="xueyeFenshu">
                           <el-input v-model="ruleForm.xueyeFenshu"
                                     placeholder="学业成绩(60%)" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="道德品行(20%)" prop="daodeFenshu">
                       <el-input v-model="ruleForm.daodeFenshu"
                                 placeholder="道德品行(20%)" clearable  :readonly="ro.daodeFenshu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="道德品行(20%)" prop="daodeFenshu">
                           <el-input v-model="ruleForm.daodeFenshu"
                                     placeholder="道德品行(20%)" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="创新创业(10%)" prop="chuangxinFenshu">
                       <el-input v-model="ruleForm.chuangxinFenshu"
                                 placeholder="创新创业(10%)" clearable  :readonly="ro.chuangxinFenshu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="创新创业(10%)" prop="chuangxinFenshu">
                           <el-input v-model="ruleForm.chuangxinFenshu"
                                     placeholder="创新创业(10%)" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="活动实践(10%)" prop="huodongFenshu">
                       <el-input v-model="ruleForm.huodongFenshu"
                                 placeholder="活动实践(10%)" clearable  :readonly="ro.huodongFenshu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="活动实践(10%)" prop="huodongFenshu">
                           <el-input v-model="ruleForm.huodongFenshu"
                                     placeholder="活动实践(10%)" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
<!--                   <el-form-item class="input" v-if="type!='info'"  label="共计(100)" prop="zongFenshu">
                       <el-input v-model="ruleForm.zongFenshu"
                                 placeholder="共计(100)" clearable  :readonly="ro.zongFenshu"></el-input>
                   </el-form-item>-->
                   <div v-if="type=='info'">
                       <el-form-item class="input" label="共计(100)" prop="zongFenshu">
                           <el-input v-model="ruleForm.zongFenshu"
                                     placeholder="共计(100)" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   xueyeFenshu: [
                              { required: true, message: '学业成绩(60%)不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   daodeFenshu: [
                              { required: true, message: '道德品行(20%)不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   chuangxinFenshu: [
                              { required: true, message: '创新创业(10%)不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   huodongFenshu: [
                              { required: true, message: '活动实践(10%)不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   zongFenshu: [
                              { required: true, message: '共计(100)不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=pingfen_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.pingfenTypesOptions = data.data.list;
                    }
                });
