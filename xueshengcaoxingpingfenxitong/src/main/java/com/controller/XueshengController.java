    ...
    */
    ...
    public R save(@RequestBody XueshengEntity xuesheng, HttpServletRequest request){
        ...
        if(xueshengEntity==null){
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"新增",xuesheng.toString());
            return R.ok();
        }else {
...
//            return R.error(511,"永远不会进入");
        ...
        if(xueshengEntity==null){
            ...
            List<String> strings = caozuorizhiService.clazzDiff(xuesheng, oldXueshengEntity, request,new String[]{"updateTime"});
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"删除",oldXueshengList.toString());
        return R.ok();
    }
...
//                            xueshengEntity.setXueshengUuidNumber(data.get(0));                    //学生唯一编号 要改的
...
//                            xueshengEntity.setXueshengAddress(data.get(0));                    //家庭住址 要改的
//                            xueshengEntity.setCreateTime(date);//时间
                        ...
                        if(xueshengEntities_xueshengUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [学生唯一编号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
                         //学生手机号
                        ...
                        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"批量新增",xueshengList.toString());
                        return R.ok();
                    }
                }
            }
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"登录",xuesheng.toString());
        return r;
    }
...
//    	ValidatorUtils.validateEntity(user);
        ...
        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"注册",xuesheng.toString());
        return R.ok();
    }
    ...
    public R resetPassword(Integer  id, HttpServletRequest request) {
        ...
        xueshengService.updateById(xuesheng);
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"重置密码",xuesheng.toString());
        return R.ok();
    }
    ...
    public R resetPass(String username, HttpServletRequest request) {
        ...
        if(xuesheng!=null){
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"忘记密码",xuesheng.toString());
            return R.ok();
        }else{
