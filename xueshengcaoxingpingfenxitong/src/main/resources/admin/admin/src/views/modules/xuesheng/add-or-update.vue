               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学生唯一编号" prop="xueshengUuidNumber">
                       <el-input v-model="ruleForm.xueshengUuidNumber"
                                 placeholder="学生唯一编号" clearable  :readonly="ro.xueshengUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="家庭住址" prop="xueshengAddress">
                       <el-input v-model="ruleForm.xueshengAddress"
                                 placeholder="家庭住址" clearable  :readonly="ro.xueshengAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    banjiTypes: false,
                    xueshengEmail: false,
                    xueshengAddress: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                    xueshengUuidNumber: new Date().getTime(),
                    xueshengName: '',
                    xueshengPhone: '',
                    xueshengIdNumber: '',
                    xueshengPhoto: '',
                ...
                rules: {
                   ...
                   xueshengUuidNumber: [
                              { required: true, message: '学生唯一编号不能为空', trigger: 'blur' },
                          ],
                   xueshengName: [
