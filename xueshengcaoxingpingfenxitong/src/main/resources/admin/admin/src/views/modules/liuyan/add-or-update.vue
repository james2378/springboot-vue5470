<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='xuesheng' && sessionTable!='laoshi'">
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info' && sessionTable!='laoshi'"  label="留言标题" prop="liuyanName">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && sessionTable!='laoshi'"  label="留言内容" prop="liuyanText">
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && sessionTable=='laoshi'"  label="回复内容" prop="replyText">
