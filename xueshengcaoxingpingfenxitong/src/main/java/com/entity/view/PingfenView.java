...
public class PingfenView extends PingfenEntity implements Serializable {
	...
	* 获取： 学期的值
	*/
	public String getPingfenValue() {
		return pingfenValue;
	}
	/**
	* 设置： 学期的值
	*/
	public void setPingfenValue(String pingfenValue) {
		this.pingfenValue = pingfenValue;
	}
